...
(function () {
  ...
  function injectMobileNavStyles() {
    ...
    style.textContent = [
      '.bl-mob-backdrop{position:fixed;inset:0;background:rgba(0,2,35,0.6);backdrop-filter:blur(4px);z-index:9000;opacity:0;pointer-events:none;transition:opacity .3s ease;}',
      ...
      '@media(max-width:991px){',
        ...
        '.bl-mob-signin{display:block;margin:20px 16px 0;padding:13px 24px;background:#FFA000;color:#000223!important;font-weight:900;font-size:15px;border-radius:50px;text-align:center;text-decoration:none;}',
        '.bl-mob-close-btn{position:absolute;top:16px;right:16px;background:rgba(255,255,255,.12);border:none;border-radius:50%;width:38px;height:38px;display:flex;align-items:center;justify-content:center;cursor:pointer;color:#fff;font-size:18px;z-index:10;}',
        '.bl-occasions-arrow{display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:50%;background:rgba(255,255,255,.1);transition:transform .28s ease;flex-shrink:0;}',
        ...
        '.bl-occasions-panel a{display:block;color:rgba(255,255,255,.82)!important;font-size:14.5px!important;font-weight:700!important;padding:11px 24px 11px 36px!important;border-bottom:1px solid rgba(255,255,255,.04)!important;text-decoration:none!important;}',
  ...
  function fixMobileNav() {
    ...
    function closeNav() {
      ...
      if (occasionsWrapper) {
        var p = occasionsWrapper.querySelector('.bl-occasions-panel');
        var ar = occasionsWrapper.querySelector('.bl-occasions-arrow');
