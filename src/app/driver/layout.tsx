...
export default function DriverLayout({
  ...
  return (
    <div
      ...
      style={{ background: "#F8F9FC", fontFamily: "'Nunito', sans-serif" }}
    >
        ...
        <div className="max-w-2xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #FFA000, #F06292)",
              }}
            >
              🍦
            </div>
            <div>
              <div className="font-black text-sm" style={{ color: "#000223" }}>
