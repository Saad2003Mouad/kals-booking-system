...
export default function DriverDashboard() {
  ...
  const updateStatus = async (id: string, jobStatus: string) => {
    ...
    setUpdating(null);
    if (selected?.id === id)
      setSelected((prev) => (prev ? { ...prev, jobStatus } : null));
  };
  ...
  if (loading)
    return (
      <div
        ...
        style={{
          background: "linear-gradient(135deg, #000223 0%, #001a4c 100%)",
        }}
      >
    ...
    return (
      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            <div className="font-black text-base" style={{ color: "#000223" }}>
  ...
  return (
    <div
      ...
      style={{ background: "#F4F4F5", fontFamily: "'Nunito', sans-serif" }}
    >
      {/* ── TOP NAV ── */}
      <div
        ...
        <div className="grid grid-cols-3 gap-3 mt-4">
          {[
            ...
            >
              ...
              <div className="text-2xl font-black" style={{ color: "#000223" }}>
                {s.value}
              </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl max-h-[92vh] overflow-y-auto">
            ...
            {mapMode ? (
              ...
              <div className="p-6">
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a
                      ...
                      className="font-bold text-sm transition-colors hover:text-[#FFA000]"
                      style={{ color: "#000223" }}
                    >
                ...
                {/* Status Buttons */}
                <div className="font-black text-xs uppercase tracking-widest text-gray-400 mb-3">
                  Update Status
                </div>
