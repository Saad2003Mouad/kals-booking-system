...
export const metadata: Metadata = {
  ...
  description:
    "Your ice cream truck has been reserved. Get ready for a legendary event!",
};
    ...
    >
      ...
      >
        <div className="max-w-2xl mx-auto px-6 py-10 text-center">
          ...
          <h1 className="text-3xl font-black" style={{ color: "#000223" }}>
            Booking Confirmed!
          </h1>
          <p
            className="text-base font-bold mt-2"
            style={{ color: "rgba(0,2,35,0.65)" }}
          >
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center">
          ...
          <div className="text-3xl font-black" style={{ color: "#000223" }}>
            #{booking.bookingNumber}
          </div>
          <div
            className="mt-3 inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-black"
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <h2 className="font-black text-xs uppercase tracking-widest text-gray-400 mb-5">
            Event Details
          </h2>
          <div className="space-y-4">
            {[
              ...
              {
                label: "Address",
                value: `${booking.address}, ${booking.city}, MA ${booking.zip}`,
              },
            ].map((row) => (
              <div
                key={row.label}
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <a
                  ...
                  className="text-sm font-black hover:text-[#FFA000] transition-colors"
                  style={{ color: "#000223" }}
                >
        ...
        >
          <h2 className="font-black text-sm text-white mb-4">
            What happens next?
          </h2>
          <div className="space-y-3">
            {[
              {
                step: "1",
                text: "Our team will review your booking within 24 hours.",
              },
              {
                step: "2",
                text:
                  "You'll receive a confirmation email at " +
                  (booking.customer?.email ?? "your email") +
                  ".",
              },
              {
                step: "3",
                text: "A driver will be assigned closer to your event date.",
              },
            ].map((item) => (
        ...
        <div className="flex flex-col sm:flex-row gap-3 pb-8">
          <a
            href="https://www.bostonlegendicecreamtruck.com"
