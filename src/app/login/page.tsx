      ...
      <main className="flex-1 flex items-start justify-center px-4 pt-8 pb-20">
        <div className="relative z-10 w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-200 relative overflow-hidden">
            ...
            <h2 className="text-[#000223] font-black text-xl mb-1">
              Welcome Back
            </h2>
            <p className="text-[#000223]/60 font-medium text-xs mb-6">
              Sign in to manage bookings, fleet &amp; tasks
            </p>
          ...
          <div className="mt-6 text-center">
            <Link
              href="/"
              className="text-xs font-bold text-slate-500 hover:text-[#FFA000] transition-colors"
            >
              ← Return to Homepage
            </Link>
          </div>
