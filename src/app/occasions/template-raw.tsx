  ...
  return (
    <>
      ...
      <div className="site-wrapper">
          ...
          <div className="w-layout-blockcontainer container w-container">
            <div className="w-embed">
              <h1 className="h1-page-hed">
                ...
                <br />
                <span className="title-event">Birthday Parties</span>
              </h1>
            </div>
            <img
        ...
        <main className="main">
          <div className="w-layout-blockcontainer container w-container">
            <div className="border-titel">Boston Birthday Bliss</div>
            <div className="row mb-100">
              <div className="service-page-col-info">
                <h2 className="h2-service-title">
                  Boston Legend Ice Cream Truck For Unforgettable Birthdays
                </h2>
                <p>
                  Make your birthday party legendary with Boston Legend Ice
                  Cream Truck! We’re here to turn your celebration into a sweet
                  and unforgettable experience. With premium ice cream,
                  professional service, and a festive atmosphere, our truck
                  delivers smiles and deliciousness for guests of all ages.
                  Whether it’s a kid's party or an adult gathering, our ice
                  cream truck guarantees a memorable touch to your special day.
                </p>
                ...
                <div className="rtb w-richtext">
                  <ul role="list">
                    <li>
                      <strong>Wide Flavor Selection:</strong> Something to
                      delight every taste bud.
                    </li>
                    <li>
                      <strong>Fun and Festive Ambiance:</strong> Adds excitement
                      and charm to your event.
                    </li>
                    <li>
                      <strong>Customizable Packages:</strong> Tailored to fit
                      your party’s needs.
                    </li>
                    <li>
                      <strong>Professional and Friendly Service:</strong>{" "}
                      Dedicated to making your event perfect.
                    </li>
                    <li>
                      <strong>Hassle-Free Setup:</strong> We handle everything,
                      so you can enjoy your party.
                    </li>
                    <li>
                      <strong>Kid-Friendly and Grown-Up Approved:</strong> Loved
                      by guests of all ages.
                    </li>
                    <li>
                      <strong>Unique Photo Opportunities:</strong> Capture
                      memorable moments with the truck.
                    </li>
                    <li>
                      <strong>Local and Reliable Service:</strong> Proudly
                      serving Greater Boston.
                    </li>
                    <li>
                      <strong>Great for Outdoor or Indoor Events:</strong>{" "}
                      Flexible for any setup.
                    </li>
                    <li>
                      <strong>Affordable Fun:</strong> A cost-effective way to
                      elevate your party.
                    </li>
                  </ul>
                  <p>
                    🎉 Let us make your birthday party a truly legendary
                    celebration!
                  </p>
                </div>
                <div className="w-layout-hflex reserve-row">
                  ...
                  <a href="/packages" className="link-bt menu-bt">
                    Reserve Now
                  </a>
                </div>
              </div>
              <div className="service-page-coll-img">
                <div className="service-min-img">
                  <img
                    src="https://cdn.prod.website-files.com/67e8ff4767b61ea98e97fe89/6811725689a09a644ee08f1b_birthday-parties-boston-legend-ice-cream-truck-catering.avif"
                    loading="lazy"
                    width="1168"
                    height="796"
                    alt="Boston Legend Ice Cream Truck For Unforgettable Birthdays"
                    sizes="(max-width: 767px) 100vw, (max-width: 991px) 728px, 940px"
                    srcSet="https://cdn.prod.website-files.com/67e8ff4767b61ea98e97fe89/6811725689a09a644ee08f1b_birthday-parties-boston-legend-ice-cream-truck-catering-p-500.avif 500w, https://cdn.prod.website-files.com/67e8ff4767b61ea98e97fe89/6811725689a09a644ee08f1b_birthday-parties-boston-legend-ice-cream-truck-catering.avif 1168w"
            ...
            <div className="book-row">
              <div className="w-layout-hflex page-book-title">
                <div className="h1-titel">
                  Delight your guests with a touch of sweet elegance — book the
                  Boston Legend ice cream truck now
                </div>
              </div>
              <div className="home-header-img-block">
                <img
                  ...
                  sizes="(max-width: 767px) 100vw, (max-width: 991px) 728px, 910px"
